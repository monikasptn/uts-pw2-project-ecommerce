                            ...
                            <div class="card">
                                <div class="card-heading active">
                                    <a class="active" data-toggle="collapse" data-target="#collapseOne">
                                        Cara Merawat Pakaian Anda?
                                    </a>
                                </div>
                                <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                    <div class="card-body">
                                        <p>Membeli pakaian yang tahan lama adalah satu hal — tetapi ada banyak hal yang dapat Anda lakukan untuk membuatnya tahan lama. Kami menyurvei desainer dan penatu yang mereka percayai untuk mendapatkan tip tentang cara merawat pakaian kami. Dan takeaway terbesar kami adalah yang pertama dan terpenting, semua yang kami kenakan harus dinikmati - dilengkapi dengan joie de vivre dan tidak takut rusak. Berikut adalah tips dari para ahli untuk memakai, menyimpan dan bahkan membersihkan pakaian Anda dengan benar untuk memperpanjang umur barang favorit Anda.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
