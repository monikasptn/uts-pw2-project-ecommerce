                    ...
                    <div class="register-form">
                        ...
                        <form action="#">
                            <div class="group-input">
                                <label for="username">Nama Pengguna atau Alamat Email *</label>
                                <input type="text" id="username" important>
                            </div>
                            <div class="group-input">
                                <label for="pass">Password *</label>
                                <input type="text" id="pass" important>
                            </div>
                            <div class="group-input">
                                <label for="con-pass">Ulangi Password *</label>
                                <input type="text" id="con-pass" important>
                            </div>
                            <button href="../Backend Side/index.php" type="submit" class="site-btn register-btn">Daftar</button>
                        </form>
