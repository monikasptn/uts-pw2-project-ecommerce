                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="cart-buttons">
                                <a href="shop.php" class="primary-btn continue-shop">Pilih Produk Lain</a>
                                <a href="#" class="primary-btn up-cart">Perbarui Keranjang</a>
                            </div>
                            <div class="discount-coupon">
                                <h6>Kode Diskon</h6>
                                <form action="#" class="coupon-form">
                                    <input type="text" placeholder="Masukkan kode Anda">
                                    <button type="submit" class="site-btn coupon-btn">Pakai</button>
                                </form>
                            </div>
                        </div>
                        <div class="col-lg-4 offset-lg-4">
                            <div class="proceed-checkout">
                                <ul>
                                    <li>Anda belum memilih produk apapun.</li>
                                </ul>
                                <a href="#" class="proceed-btn">PROSES UNTUK CHECK OUT</a>
                            </div>
                        </div>
                    </div>
                </div>
